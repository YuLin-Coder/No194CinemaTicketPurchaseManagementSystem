...
<body>
    ...
    <script>
        ...
        function initEmail(){
            ...
            if(user!=null){
            	user = eval('(' + user + ')');
            	email.append("<span class=\"email-num\">"+user.user_email+"</span>");
            }
        }
        ...
        function buySeat(i,j){
            ...
            if((SeatMax<4) && (row.className == "seat selectable")){
                ...
                TicketPrice.text("￥"+(PriceTemp-couponPrice)*SeatMax);
            }
            //取消
                ...
                success:function (obj) {
                	if(obj.code == 200){
                       ...
                       showInfo.append(
                           ...
                           "<div class=\"info-item\">" +
                               "<span>优惠：</span>" +
                               "<span class=\"value\">￥" + obj.coupon + "/张</span>" +
                           "</div>"
                       );
                       initSeat();
                	}
